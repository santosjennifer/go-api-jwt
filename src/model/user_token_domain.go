...
func (ud *userDomain) GenerateToken() (string, *rest_error.RestErr) {
...
func VerifyToken(tokenValue string) (UserDomainInterface, *rest_error.RestErr) {
	secret := os.Getenv(JWT_SECRET_KEY)
	...
	if err != nil {
		return nil, rest_error.NewUnauthorizedRequestError("invalid token")
	}
...
func VerifyTokenMiddleware(c *gin.Context) {
	...
	if err != nil {
		errRest := rest_error.NewUnauthorizedRequestError("invalid token")
